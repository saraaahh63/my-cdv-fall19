...
function gotData(incomingData){
  ...
  function CHNline(d,i){
    
  }

  document.getElementById("US").addEventListener("click", USline)

  document.getElementById("CHN").addEventListener("click", CHNline)
